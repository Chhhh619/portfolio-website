    ...
    const projects = [
        {
            ...
            fullDescription:
                'A production-grade mobile-first finance tracker built for Malaysian users. It ingests bank/e-wallet notifications and receipt screenshots, then uses Gemini 2.5 Flash via a Supabase Edge Function to extract structured transactions with the amount, merchant, direction, category, and a confidence score. Features multi-entry parsing, smart-merge duplicate detection, user-defined categories that become runtime AI routing options, iOS Shortcuts integration for one-tap capture, and offline-queued writes that sync when back online. Ships as an installable PWA with auth-gated multi-device sync over Supabase Postgres.',
        ...
        },
        {
            ...
            fullDescription:
                'SAPOT.AI is a sales enablement platform that leverages AI to coach and evaluate sales assistants in real time. It surfaces performance insights, flags conversation gaps, and helps teams convert more consistently across multilingual markets.',
        ...
        },
        {
            ...
            fullDescription:
                'A corporate marketing site for CariSEO, an AI SEO platform. The landing page explains what the product does, from AI-driven ranking optimisation to intelligent content recommendations, in a fast, responsive, SEO-optimised experience.',
        ...
        },
        {
            ...
            fullDescription:
                'A design-led cafe website exploring a minimalist visual language of clean typography, a restrained palette, and generous spacing. Built with vanilla HTML/CSS/JavaScript to stay lightweight and easy to host anywhere, with full responsiveness across mobile, tablet, and desktop.',
